...
final List<Restaurant> restaurantsData = [
  Restaurant(
    ...
    wiseScore: 92,
    wiseReason:
        'Decent protein source, but slightly high in fats for your current progress. Great if you skip the extra cheese.',
      ...
      MenuCategory(
        ...
        items: [
          MenuItem(
            ...
            price: '\$18.50',
            description:
                'Wild mushrooms, truffle oil, fresh mozzarella, and thyme.',
            calories: 850,
          ),
          MenuItem(
            name: 'Spicy Salami',
            price: '\$17.00',
            description:
                'Calabrese salami, honey, chili flakes, and San Marzano tomatoes.',
            calories: 920,
          ),
          MenuItem(
            name: 'Garden Veggie',
            price: '\$16.00',
            description:
                'Roasted peppers, artichokes, olives, and vegan pesto.',
            calories: 740,
          ),
        ],
      ),
      MenuCategory(
        ...
        items: [
          MenuItem(
            name: 'Garlic Knots',
            price: '\$6.50',
            description: 'Olive oil, roasted garlic, and parmesan dip.',
            calories: 450,
          ),
        ],
      ),
  ...
  Restaurant(
    ...
    wiseScore: 95,
    wiseReason:
        'Perfectly matches your fiber goals for today. High protein salad base helps you reach your 120g target.',
      ...
      MenuCategory(
        ...
        items: [
          MenuItem(
            ...
            price: '\$12.00',
            description:
                'Organic quinoa, kale, cherry tomatoes, and lemon-tahini dressing.',
            calories: 420,
          ),
          MenuItem(
            ...
            price: '\$15.50',
            description:
                'Wild-caught salmon, brown rice, edamame, and pickled ginger.',
            calories: 580,
          ),
        ],
      ),
  ...
  Restaurant(
    ...
    wiseScore: 85,
    wiseReason:
        'High quality proteins, but higher carb count from rice might exceed your daily limit if ordered with rolls.',
      ...
      MenuCategory(
        ...
        items: [
          ...
          MenuItem(
            ...
            price: '\$18.00',
            description:
                'Crab meat, cucumber, topped with tuna, salmon, and yellowtail.',
            calories: 480,
          ),
        ],
      ),
  ...
  Restaurant(
    ...
    wiseScore: 80,
    wiseReason:
        'Decent pasta choices, but generally high in simple carbs. Recommended only if you need a high carb load before an intensive study session.',
      ...
      MenuCategory(
        ...
        items: [
          MenuItem(
            ...
            price: '\$21.00',
            description: 'Slow-cooked beef ragu with fresh wide-cut egg pasta.',
            calories: 880,
          ),
          MenuItem(
            ...
            price: '\$23.00',
            description:
                'Guanciale, pecorino romano, egg yolk, and freshly shaved black truffle.',
            calories: 950,
          ),
        ],
      ),
