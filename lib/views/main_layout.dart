...
class _MainLayoutState extends State<MainLayout> {
  ...
  final String _aiRecommendationText = "Your fiber and protein intakes are slightly behind today. Consider a clean dinner.";
  ...
  void initState() {
    ...
    _budgetData = BudgetData(
      ...
      history: [
        BudgetPeriod(period: 'Apr 2026', limit: 12000, spent: 10500, type: 'monthly'),
        BudgetPeriod(period: 'Mar 2026', limit: 10000, spent: 11200, type: 'monthly'),
        BudgetPeriod(period: 'Feb 2026', limit: 10000, spent: 8900, type: 'monthly'),
      ],
    );

    // 初始化好友名單
    _friendsList = [
      FriendProfile(uid: 'user_01', displayName: 'Alex Carter', score: 92, shareId: 'HEALTHY88', achievementsCount: 24),
      FriendProfile(uid: 'user_02', displayName: 'Sarah Jenkins', score: 75, shareId: 'FITSCOUT', achievementsCount: 8),
      FriendProfile(uid: 'user_03', displayName: 'Emma Watson', score: 58, shareId: 'AVOCADO22', achievementsCount: 3),
    ];

    // 初始化 AnalysisView 所需的數據模型
    _userStats = UserStats(
      goals: Nutrients(calories: 2000, protein: 120, carbs: 250, fat: 65, fiber: 25, fruit: 3),
      current: Nutrients(calories: 830, protein: 55, carbs: 45, fat: 28, fiber: 14, fruit: 1),
      remaining: Nutrients(calories: 1170, protein: 65, carbs: 205, fat: 37, fiber: 11, fruit: 2),
    );
    ...
    _mealRecords = [
      MealRecord(
        ...
        healthScore: 85,
        cost: 160,
        nutrients: Nutrients(calories: 450, protein: 40, carbs: 15, fat: 10, fiber: 6, fruit: 0),
      ),
      MealRecord(
        id: 'record_02',
        ...
        healthScore: 90,
        cost: 120,
        nutrients: Nutrients(calories: 380, protein: 15, carbs: 30, fat: 18, fiber: 8, fruit: 1),
      ),
    ];
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      extendBody: true, 
      appBar: WiseNavbar(
        onSettingsClick: () => print('Open Settings Sidebar'),
            ...
            child: SizedBox(
              ...
              child: Row(
                ...
                children: [
                  ...
                  _buildNavItem(2, Icons.bar_chart_outlined, Icons.bar_chart_rounded, 'Analysis'), 
  ...
  Widget _buildNavItem(int index, IconData icon, IconData activeIcon, String label) {
    ...
    final Color color = isActive ? const Color(0xFF059669) : Colors.green.shade400; 
